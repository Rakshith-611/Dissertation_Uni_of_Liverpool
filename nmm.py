...
def terminal(board, user_pieces, ai_pieces, r_user_pieces, r_ai_pieces):
    ...
    # if either the player still has pieces left to place, game not over
    if user_pieces > 0 or ai_pieces > 0:
...
def minimax(board, difficulty, player, user_pieces, ai_pieces):
    ...
    if difficulty == BEGINNER:
        ...
        print("---------------------------------------------\n"
              f"Best move in the current situation is:\n{best_move}\n"
              "---------------------------------------------")
        return best_move
    ...
    # hard difficulty, make a move looking 2 turns forward
        ...
        all_user_moves = {}
        for i, b in enumerate(ai1_boards):
            user_moves = []
            v_max = -math.inf
    ...
    print("\n-----------------------------------------------\n"
          f"The best move in the current situation is:\n{best_move}\n"
          "-----------------------------------------------")
    return best_move
